...
public class AuthenticationService : IAuthenticationService
{
    ...
    {
        // validate the incomming user DTO using FluentValidation.
        ...
        if (result.Succeeded)
        {
            await _emailSender.SendConfirmationEmail(registerDto.Email,user); 
    ...
    public async Task<TokenResponse> LoginAsync(LoginDto loginDto)
    {
        ...
        {
            return new TokenResponse( token, refreshToken, "Confirm your email to continue."); 
        }
